...
class Building {
  protected:
    ...
    public:
    Building(string city, int buildingNumber, int age, int area, Material material);
...
class House : public Building{
  ...
  public:
    House(string city, vector<string> residents, int age, int area, Material material, string neighborhood, int buildingNumber) : Building(city, buildingNumber, age, area, material) {
